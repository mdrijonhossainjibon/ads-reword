...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-400 lg:hidden"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            return (
              <Link
                ...
                className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors duration-200 ${
                  isActive
                    ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-500'
              ...
              >
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="w-1.5 h-1.5 ml-auto rounded-full bg-blue-600 dark:bg-blue-500"
                  />
                )}
              </Link>
            );
      ...
      {/* Main Content */}
      <div className={`transition-all duration-200 ${isSidebarOpen ? 'pl-[280px]' : 'pl-0'}`}>
        {/* Top Bar */}
